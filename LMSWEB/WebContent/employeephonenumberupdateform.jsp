...
<table>
<tr>
<th>Employee Id</th><th>First Name</th><th>Last Name</th><th>Email</th><th>PhoneNumber</th><th>DateOfBirth</th><th>HireDate</th><th>Salary</th><th>Designation</th><th>JobLocation</th><th>UpdatePhoneNumber</th>
</tr>
...
<td>
<form method="post" action="<c:url value="Hrservlet?action=updatephonenumberform&employeeId=${retriveEmployeemodel.employeeId}"></c:url>">
