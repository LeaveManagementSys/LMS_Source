...
insert into employees values('E103','Pavani','Ankam','pavani@gmail.com','06-DEC-1998',9198989879,27900,'hyderabad','gachibowli','software engineer');
...
create table leaves(leave_Id integer primary key,emp_Id varchar(10),foreign key(emp_Id) references employees(employee_Id),
leave_Type varchar2(20),from_Date date,to_Date date,designation varchar2(20),leave_Desc varchar2(40),leave_Balances number(10),leave_Status varchar2(20)); 

insert into leaves values('501','E100','CasualLeave','02-OCT-2019','02-OCT-2019','associate engineer','Nill',20,'Approved');
insert into leaves values('503','E101','CasualLeave','05-OCT-2019','05-OCT-2019','associate engineer','Nill',14,'Approved');
